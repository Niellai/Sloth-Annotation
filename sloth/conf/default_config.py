...
LABELS = (
	{
        'attributes': {
            'type': 'Critical',
            'class': 'Critical',
            "id":    ["Blowholes_over_specs", "Blowholes_over_copper", "Blowholes_over_PCA", "Blowholes_adhesive_bottom", "Bubbles_over_specs",
					"Insufficent_coverage", "Insufficent_Tiebar", "Crack", "Contamination", "Delamination", "Ecessive", "Insufficent"
					"Damage", "Discoloration", "Dent", "Expose_flex", "Fense_on_flex"],
        },
	...
	{
		'attributes': {
			'type': 'Critical_Region',
			'class': 'Critical_Region',
			"id":    ["Critical_Region"],
		},
		'inserter': 'sloth.items.RectItemInserter',
		'item': 'sloth.items.IDRectItem',
		'text': 'Critical_Region',
    },
)
